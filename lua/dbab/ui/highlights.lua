...
function M.setup()
  ...
  local highlights = {
    ...
    DbabSidebarIconPK = { link = "DiagnosticError" },
    -- Sidebar (text)
    ...
    DbabHistoryDelete = { link = "DiagnosticError" },
    DbabHistoryCreate = { link = "String" },
    DbabHistoryDrop = { link = "DiagnosticError" },
    DbabHistoryAlter = { link = "Special" },
    DbabHistoryTruncate = { link = "DiagnosticWarn" },
    -- History hints
    DbabHistoryHintWhere = { link = "DiagnosticWarn" },
    ...
    DbabTabModified = { link = "DiagnosticWarn" },
